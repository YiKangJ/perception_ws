...
int main(int argc, char *argv[])
{
  ...
  float voxel_leaf_size, x_filter_min, y_filter_min, z_filter_min, x_filter_max,
      y_filter_max, z_filter_max, plane_max_iter, plane_dist_thresh, cluster_tol, cluster_min_size, cluster_max_size;
  ...
  x_filter_min = priv_nh_.param<float>("x_filter_max", -2.5);
  y_filter_min = priv_nh_.param<float>("y_filter_max", 2.5);
  z_filter_min = priv_nh_.param<float>("z_filter_max", -2.5);
